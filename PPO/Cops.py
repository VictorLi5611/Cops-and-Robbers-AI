...
class Cop:
    def __init__(self, pos, bank):
        ...
        self.corners[(bank[0] - radius, bank[1] - radius)] = (0, 1) # Top Left corner -> go down
        self.corners[(bank[0] - radius, bank[1] + radius)] = (1, 0) # Bottom left corner -> Go right
        self.corners[(bank[0] + radius, bank[1] + radius)] = (0, -1) # Bottom right corner -> Go up
        self.corners[(bank[0] + radius, bank[1] - radius)] = (-1, 0) # Top right corenr -> go left

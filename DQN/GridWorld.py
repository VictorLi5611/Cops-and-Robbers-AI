...
class GridWorld(gym.Env):
    ...
    def __init__(self, render_mode=None, init_state=None, goal=None, size=GRID_SIZE, num_cops=NUM_COPS):
        ...
        self.observation_space = spaces.Dict(
            {
                "vision": spaces.Box(-1000, 100, shape=(25,), dtype=float),  #vision is the 9x9 grid around the robber
        ...
        for i in range(self.num_cops):
            self.cop_position.append(np.array([np.random.randint(0, size), np.random.randint(0, size)], dtype=int))

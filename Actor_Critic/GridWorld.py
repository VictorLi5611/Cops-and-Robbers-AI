...
class GridWorld(gym.Env):
    ...
    def __init__(self, render_mode=None, init_state=None, goal=None, size=GRID_SIZE, num_cops = NUM_COPS, vision = VISION_RADIUS):
        ...
        self.observation_space = spaces.Dict(
            {
                "vision": spaces.Box(-1000, 100, shape=((vision*2 + 1)*(vision*2 + 1),), dtype=float),  #vision is the 9x9 grid around the robber
